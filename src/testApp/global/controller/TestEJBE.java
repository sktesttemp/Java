...
public class TestEJBE extends HttpServlet
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			TestComponentE beanObj;
			//-TestLocalComponent beanObj;
			
			beanObj = testHome.findByPrimaryKey(strEmpName);
		...
		{	
			...
			pw.print("<h4>Welcome Mr/Ms "+strName+"!</h4>");	
			pw.print("<h5>Your Information:</h6>");	
			pw.print("<h6>Employee ID: "+strId+"!</h6>");	
			pw.print("<h6>Date of Birth: "+strDOB+"!</h6>");	
			pw.print("<h6>Address: "+strAddr+"!</h6>");	
